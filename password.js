...
function generatePW() {
  ...
  console.log(password); // REMOVE THIS BEFORE SUBMITTING!!!

  // Display password on screen
  function displayPW() {

    // Create and style 'p' tag to hold our password string 
    ...
    // pwInput.setAttribute("width", "100%");

    pwInput.value = password

    // document.getElementById("my_input").value = password;
    // ptag.setAttribute("style", "textAlign:center");
    document.getElementById("password_display").appendChild(pwInput);
  }
